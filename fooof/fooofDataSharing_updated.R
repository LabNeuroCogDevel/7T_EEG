...
## 6.2 GLU VS Exponent ----
  ...
  lunaize(ggplot(data = fooofMRS , 
            ...
            geom_point(alpha=.5) + geom_smooth(aes(group = 1),method=mgcv::"gam", formula = y ~ s(x, k = 3, fx = T), alpha = 0.8) + 
            scale_color_manual(values=c("gold3", "blue4"))) + 
    ylab("Glutamate") + xlab("Exponent") + theme(text = element_text(size = 30)) + theme(legend.position='none')
  
  
  lm.model <- lmer(Exponent ~  gluRes.residuals+ age.x + Condition + Region + (1|luna), data = fooofMRS )
  car::Anova(lm.model)
  summ(lm.model)
...
# 9.0 FOOOF vs Behavior ----
  
## 9.1 Load and prep behavior ----
  
  z_thresh = 2
  data <- merge(
    read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Behavior_20220819.csv') %>% mutate(Subject = paste0(LunaID, '_', ScanDate)), 
    read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/agefile_20220914.csv'), 
    by='Subject')
...
## 9.2.1 accuracy VS Exponent ----
  ...
  AIC(lmer(Exponent ~ absBestError+ inverseAge + Condition + Region + (1|luna), data = fooofMRSbehavior), 
      lmer(Exponent ~ absBestError+ age.x + Condition + Region + (1|luna), data = fooofMRSbehavior))
...
## 9.2.2 accuracy var VS Exponent ----
  ...
  AIC(lmer(Exponent ~ absBestError_sd+ inverseAge + Condition + Region + (1|luna), data = fooofMRSbehavior), 
      lmer(Exponent ~ absBestError_sd+ age.x + Condition + Region + (1|luna), data = fooofMRSbehavior))
...
## 9.2.3 accuracy var VS offset ----
  ...
  AIC(lmer(Offset ~ absBestError_sd+ inverseAge + Condition + Region + (1|luna), data = fooofMRSbehavior), 
      lmer(Offset ~ absBestError_sd+ age.x + Condition + Region + (1|luna), data = fooofMRSbehavior))
...
## 9.2.4 accuracy  VS offset ----
  ...
  AIC(lmer(Offset ~ absBestError+ inverseAge + Condition + Region + (1|luna), data = fooofMRSbehavior), 
      lmer(Offset ~ absBestError+ age.x + Condition + Region + (1|luna), data = fooofMRSbehavior))
...
## 9.2.5 latency  VS offset ----
  ...
  AIC(lmer(Offset ~ mgsLatency+ inverseAge + Condition + Region + (1|luna), data = fooofMRSbehavior), 
      lmer(Offset ~ mgsLatency+ age.x + Condition + Region + (1|luna), data = fooofMRSbehavior))
...
## 9.2.6 latency var  VS offset ----
  ...
  AIC(lmer(Offset ~ mgsLatency_sd + inverseAge + Condition + Region + (1|luna), data = fooofMRSbehavior), 
      lmer(Offset ~ mgsLatency_sd + age.x + Condition + Region + (1|luna), data = fooofMRSbehavior))
...
## 9.2.7 latency  VS exponent ----
  ...
  AIC(lmer(Exponent ~ mgsLatency + inverseAge + Condition + Region + (1|luna), data = fooofMRSbehavior), 
      lmer(Exponent ~ mgsLatency + age.x + Condition + Region + (1|luna), data = fooofMRSbehavior))
...
## 9.2.9 latency var  VS exponent ----
  ...
  AIC(lmer(Exponent ~ mgsLatency_sd + inverseAge + Condition + Region + (1|luna), data = fooofMRSbehavior), 
      lmer(Exponent ~ mgsLatency_sd + age.x + Condition + Region + (1|luna), data = fooofMRSbehavior))
...
## 9.2.10 accuarcy VS imbalance ----
  ...
  AIC(lmer(GluGABAimbalanceABS ~ absBestError + inverseAge + Region + (1|luna), data = fooofMRSbehavior), 
      lmer(GluGABAimbalanceABS ~ absBestError + age.x  + Region + (1|luna), data = fooofMRSbehavior))
...
## 9.2.11 accuracy var  VS imbalance ----
  ...
  AIC(lmer(GluGABAimbalanceABS ~ absBestError_sd + inverseAge + Region + (1|luna), data = fooofMRSbehavior), 
      lmer(GluGABAimbalanceABS ~ absBestError_sd + age.x  + Region + (1|luna), data = fooofMRSbehavior))
...
## 9.2.12 Lat VS imbalance ----
  ...
  AIC(lmer(GluGABAimbalanceABS ~ mgsLatency + inverseAge + Region + (1|luna), data = fooofMRSbehavior), 
      lmer(GluGABAimbalanceABS ~ mgsLatency + age.x  + Region + (1|luna), data = fooofMRSbehavior))
...
## 9.2. 13 Lat Var VS imbalance ----
  ...
  AIC(lmer(GluGABAimbalanceABS ~ mgsLatency_sd + inverseAge + Region + (1|luna), data = fooofMRSbehavior), 
      lmer(GluGABAimbalanceABS ~ mgsLatency_sd + age.x  + Region + (1|luna), data = fooofMRSbehavior))
...
## 9.2.14 accuracy VS ratio ----
  ...
  AIC(lmer(ratioRes.residuals ~ absBestError + inverseAge + Region + (1|luna), data = fooofMRSbehavior), 
      lmer(ratioRes.residuals ~ absBestError + age.x  + Region + (1|luna), data = fooofMRSbehavior))
...
## 9.2.15 accuracy variability  VS ratio ----
  ...
  AIC(lmer(ratioRes.residuals ~ absBestError_sd + inverseAge + Region + (1|luna), data = fooofMRSbehavior), 
      lmer(ratioRes.residuals ~ absBestError_sd + age.x  + Region + (1|luna), data = fooofMRSbehavior))
...
## 9.2.16 Latency VS ratio ----
  ...
  AIC(lmer(ratioRes.residuals ~ mgsLatency + inverseAge + Region + (1|luna), data = fooofMRSbehavior), 
      lmer(ratioRes.residuals ~ mgsLatency + age.x  + Region + (1|luna), data = fooofMRSbehavior))
...
## 9.2.17 Lat Var VS ratio ----
  ...
  AIC(lmer(ratioRes.residuals ~ mgsLatency_sd + inverseAge + Region + (1|luna), data = fooofMRSbehavior), 
      lmer(ratioRes.residuals ~ mgsLatency_sd + age.x  + Region + (1|luna), data = fooofMRSbehavior))
