...
addpath(('C:\Users\sdm42\OneDrive - University of Pittsburgh\1. Recording & Stimulation of iEEG\Image Reconstruction\customFcns'))
addpath(genpath('Functions'));

datapath = hera('/Projects/7TBrainMech/scripts/eeg/Shane/sEEG/SubjectFolders/');
...
savePath = hera('/Projects/7TBrainMech/scripts/eeg/Shane/sEEG/SubjectFolders/');
%load in all the files
setfiles0 = dir([datapath, 'P*']);
setfiles = {};
...
for j = 1:length(setfiles0)
    ...
    if isfile([savePath, idvalues(j,:), '\data.mat']) % is there a .mat file for the patient
        ...
        addpath(genpath('C:\Users\sdm42\OneDrive - University of Pittsburgh\abelCode\ripple\Tools\neuroshare'))
        [nsResult,hFile] = ns_OpenFile(fullfile([datapath, idvalues(j,:), '\rest0001.ns2']));
