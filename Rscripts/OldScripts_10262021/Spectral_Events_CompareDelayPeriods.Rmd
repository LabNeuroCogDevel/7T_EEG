...
GammaT  <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Gamma/Delay1_2/Gamma_subs_1_2.csv')
AlphaT  <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Alpha/Delay1_2/Alpha_Subs_data_1_2.csv')
BetaT  <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Beta/Delay1_2/Beta_subs_data1_2.csv')
ThetaT  <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Theta/Delay1_2/Theta_Subs_data1_2.csv')
...
PerSubjectGamma <- merge(Avg_log1p_gamma_power, TrialVar_log1p_gamma_power, by = 'Subject', suffix = c("_mean", "_SD"), all.x = TRUE, all.y = TRUE )
...
PerSubjectAlpha <- merge(Avg_log1p_alpha_power, TrialVar_log1p_alpha_power, by = 'Subject', suffix = c("_mean", "_SD"),  all.x = TRUE, all.y = TRUE )
...
PerSubjectTheta <- merge(Avg_log1p_theta_power, TrialVar_log1p_theta_power, by = 'Subject', suffix = c("_mean", "_SD"),  all.x = TRUE, all.y = TRUE )
...
PerSubjectBeta <- merge(Avg_log1p_beta_power, TrialVar_log1p_beta_power, by = 'Subject', suffix = c("_mean", "_SD"),  all.x = TRUE, all.y = TRUE )
...
<!-- ggplot(data = PerSubjectGamma[PerSubjectGamma$visitno < 2,],  aes(x = age, y = log1p_Gamma_Trial_Power_mean )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Average Trial Gamma Power vs Age") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Age") + ylab("Power") -->

<!-- lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2,], log1p_Gamma_Trial_Power_mean ~ ageInverse) -->
<!-- anova(lm.model) -->

<!-- ggplot(data = PerSubjectGamma[PerSubjectGamma$visitno < 2,],  aes(x = age, y = log1p_Gamma_Trial_Power_SD )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Between Trial Variability of Gamma Power vs Age") + theme(plot.title = element_text(hjust = 0.5))+ xlab("Age") + ylab("SD(Power)") -->
<!-- lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2,], log1p_Gamma_Trial_Power_SD ~ ageInverse) -->
<!-- anova(lm.model) -->
...
<!-- ```{r, echo= FALSE, message = FALSE, warning = FALSE} -->
<!-- #alpha -->
<!-- ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2,],  aes(x = age, y = log1p_Alpha_Trial_Power_mean )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Average Trial Alpha Power vs Age") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Age") + ylab("Power") -->
<!-- lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2,], log1p_Alpha_Trial_Power_mean ~ ageInverse) -->
<!-- anova(lm.model) -->

<!-- ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2,],  aes(x = age, y = log1p_Alpha_Trial_Power_SD )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Between Trial Variability of Alpha Power vs Age") + theme(plot.title = element_text(hjust = 0.5))+ xlab("Age") + ylab("SD(Power)") -->
<!-- lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2,], log1p_Alpha_Trial_Power_SD ~ ageInverse) -->
<!-- anova(lm.model) -->
...
<!-- ```{r echo=FALSE, message=FALSE, warning=FALSE} -->
<!-- #theta -->
<!-- ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2,],  aes(x = age, y = log1p_Theta_Trial_Power_mean )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Average Trial Theta Power vs Age") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Age") + ylab("Power") -->
<!-- lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2,], log1p_Theta_Trial_Power_mean ~ ageInverse) -->
<!-- anova(lm.model) -->

<!-- ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2,],  aes(x = age, y = log1p_Theta_Trial_Power_SD )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Between Trial Variability of Theta Power vs Age") + theme(plot.title = element_text(hjust = 0.5))+ xlab("Age") + ylab("SD(Power)") -->
<!-- lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2,], log1p_Theta_Trial_Power_SD ~ ageInverse) -->
<!-- anova(lm.model) -->
...
<!-- ```{r echo=FALSE, message=FALSE, warning=FALSE} -->
<!-- #beta -->
<!-- ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno < 2,],  aes(x = age, y = log1p_Beta_Trial_Power_mean )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Average Trial Beta Power vs Age") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Age") + ylab("Power") -->
<!-- lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno < 2,], log1p_Beta_Trial_Power_mean ~ ageInverse) -->
<!-- anova(lm.model) -->

<!-- ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno < 2,],  aes(x = age, y = log1p_Beta_Trial_Power_SD )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Between Trial Variability of Beta Power vs Age") + theme(plot.title = element_text(hjust = 0.5))+ xlab("Age") + ylab("SD(Power)") -->
<!-- lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno < 2,], log1p_Beta_Trial_Power_SD ~ ageInverse) -->
<!-- anova(lm.model) -->
...
<!-- modelFit <- lmer(absPositionError ~ age.x + log1p_Gamma_Trial_Power + (1|Subject), data = Everything[Everything$visitno.x < 2 & Everything$log1p_Gamma_Trial_Power != '-Inf',], na.action = na.omit) -->
<!-- car::Anova(modelFit) -->
<!-- ``` -->
...
<!-- ```{r echo=FALSE, message=FALSE, warning=FALSE} -->
<!-- Everything$Subject <- as.factor(Everything$Subject) -->
<!-- modelFit <- lmer(mgsLatency ~ age.x + log1p_Gamma_Trial_Power + (1|Subject), data = Everything[Everything$visitno.x < 2 & Everything$log1p_Gamma_Trial_Power != '-Inf',], na.action = na.omit) -->
<!-- car::Anova(modelFit) -->
<!-- ``` -->
...
<!-- ```{r echo=FALSE, message=FALSE, warning=FALSE} -->
<!-- Everything$Subject <- as.factor(Everything$Subject) -->
<!-- modelFit <- lmer(absPositionError ~ age.x + log1p_Alpha_Trial_Power + (1|Subject), data = Everything[Everything$visitno.x < 2 & Everything$log1p_Alpha_Trial_Power != '-Inf',], na.action = na.omit) -->
<!-- car::Anova(modelFit) -->
<!-- ``` -->
...
<!-- ```{r echo=FALSE, message=FALSE, warning=FALSE} -->
<!-- Everything$Subject <- as.factor(Everything$Subject) -->
<!-- modelFit <- lmer(mgsLatency ~ age.x + log1p_Alpha_Trial_Power + (1|Subject), data = Everything[Everything$visitno.x < 2 & Everything$log1p_Alpha_Trial_Power != '-Inf',], na.action = na.omit) -->
<!-- car::Anova(modelFit) -->
<!-- ``` -->
...
<!-- ```{r echo=FALSE, message=FALSE, warning=FALSE} -->
<!-- Everything$Subject <- as.factor(Everything$Subject) -->
<!-- modelFit <- lmer(absPositionError ~ age.x + log1p_Theta_Trial_Power + (1|Subject), data = Everything[Everything$visitno.x < 2 & Everything$log1p_Theta_Trial_Power != '-Inf',], na.action = na.omit) -->
<!-- car::Anova(modelFit) -->
<!-- ``` -->
...
<!-- ```{r echo=FALSE, message=FALSE, warning=FALSE} -->
<!-- Everything$Subject <- as.factor(Everything$Subject) -->
<!-- modelFit <- lmer(mgsLatency ~ age.x + log1p_Theta_Trial_Power + (1|Subject), data = Everything[Everything$visitno.x < 2 & Everything$log1p_Theta_Trial_Power != '-Inf',], na.action = na.omit) -->
<!-- car::Anova(modelFit) -->
<!-- ``` -->
...
<!-- ```{r echo=FALSE, message=FALSE, warning=FALSE} -->
<!-- Everything$Subject <- as.factor(Everything$Subject) -->
<!-- modelFit <- lmer(absPositionError ~ age.x + log1p_Beta_Trial_Power + (1|Subject), data = Everything[Everything$visitno.x < 2 & Everything$log1p_Beta_Trial_Power != '-Inf',], na.action = na.omit) -->
<!-- car::Anova(modelFit) -->
<!-- ``` -->
...
<!-- ```{r echo=FALSE, message=FALSE, warning=FALSE} -->
<!-- Everything$Subject <- as.factor(Everything$Subject) -->
<!-- modelFit <- lmer(mgsLatency ~ age.x + log1p_Beta_Trial_Power + (1|Subject), data = Everything[Everything$visitno.x < 2 & Everything$log1p_Beta_Trial_Power != '-Inf',], na.action = na.omit) -->
<!-- car::Anova(modelFit) -->
<!-- ``` -->
...
<!-- ggplot(data = PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$absPositionError < excludeHigh & PerSubjectGamma$absPositionError > excludeLow ,],  aes(x = absPositionError, y = log1p_Gamma_Trial_Power_mean )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Gamma Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("Power") -->
<!-- lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$absPositionError < excludeHigh & PerSubjectGamma$absPositionError > excludeLow,], log1p_Gamma_Trial_Power_mean ~ absPositionError) -->
<!-- anova(lm.model) -->

<!-- ggplot(data = PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$absPositionError < excludeHigh & PerSubjectGamma$absPositionError > excludeLow,],  aes(x = absPositionError, y = log1p_Gamma_Trial_Power_SD )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Gamma Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("SD(Power)") -->
<!-- lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$absPositionError < excludeHigh & PerSubjectGamma$absPositionError > excludeLow,], log1p_Gamma_Trial_Power_SD ~ absPositionError) -->
<!-- anova(lm.model) -->
...
<!-- ggplot(data = PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$absPositionError < excludeHigh & PerSubjectGamma$absPositionError > excludeLow & PerSubjectGamma$Group == 4,],  aes(x = absPositionError, y = log1p_Gamma_Trial_Power_mean )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Gamma Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("Power") -->
<!-- lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$absPositionError < excludeHigh & PerSubjectGamma$absPositionError > excludeLow & PerSubjectGamma$Group == 4,], log1p_Gamma_Trial_Power_mean ~ absPositionError) -->
<!-- anova(lm.model) -->

<!-- ggplot(data = PerSubjectGamma[PerSubjectGamma$visitno < 2 &PerSubjectGamma$absPositionError < excludeHigh & PerSubjectGamma$absPositionError > excludeLow & PerSubjectGamma$Group == 4,],  aes(x = absPositionError, y = log1p_Gamma_Trial_Power_SD )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Gamma Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("SD(Power)") -->
<!-- lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$absPositionError < excludeHigh & PerSubjectGamma$absPositionError > excludeLow & PerSubjectGamma$Group == 4,], log1p_Gamma_Trial_Power_SD ~ absPositionError) -->
<!-- anova(lm.model) -->
...
<!-- ggplot(data = PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$mgsLatency > excludeLow & PerSubjectGamma$mgsLatency < excludeHigh,],  aes(x = mgsLatency, y = log1p_Gamma_Trial_Power_mean )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Gamma Power vs Latency") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Latency") + ylab("Power") -->
<!-- lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$mgsLatency > excludeLow & PerSubjectGamma$mgsLatency < excludeHigh,], log1p_Gamma_Trial_Power_mean ~ mgsLatency) -->
<!-- anova(lm.model) -->

<!-- ggplot(data = PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$mgsLatency > excludeLow & PerSubjectGamma$mgsLatency < excludeHigh,],  aes(x = mgsLatency, y = log1p_Gamma_Trial_Power_SD )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Gamma Power vs Latency") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Latency") + ylab("SD(Power)") -->
<!-- lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$mgsLatency > excludeLow & PerSubjectGamma$mgsLatency < excludeHigh,], log1p_Gamma_Trial_Power_SD ~ mgsLatency) -->
<!-- anova(lm.model) -->
...
<!-- ggplot(data = PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$Group == 4 & PerSubjectGamma$mgsLatency < excludeHigh & PerSubjectGamma$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = log1p_Gamma_Trial_Power_mean )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Gamma Power vs Latency") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Latency") + ylab("Power") -->
<!-- lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$Group == 4 & PerSubjectGamma$mgsLatency < excludeHigh & PerSubjectGamma$mgsLatency > excludeLow,], log1p_Gamma_Trial_Power_mean ~ mgsLatency) -->
<!-- anova(lm.model) -->

<!-- ggplot(data = PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$Group == 4 & PerSubjectGamma$mgsLatency < excludeHigh & PerSubjectGamma$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = log1p_Gamma_Trial_Power_SD )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Gamma Power vs Latency") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Latency") + ylab("SD(Power)") -->
<!-- lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$Group == 4 & PerSubjectGamma$mgsLatency < excludeHigh & PerSubjectGamma$mgsLatency > excludeLow,], log1p_Gamma_Trial_Power_SD ~ mgsLatency) -->
<!-- anova(lm.model) -->
...
<!-- ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$absPositionError < excludeHigh & PerSubjectAlpha$absPositionError > excludeLow,],  aes(x = absPositionError, y = log1p_Alpha_Trial_Power_mean )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Alpha Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("Power") -->
<!-- lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$absPositionError < excludeHigh & PerSubjectAlpha$absPositionError > excludeLow,], log1p_Alpha_Trial_Power_mean ~ absPositionError) -->
<!-- anova(lm.model) -->

<!-- ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$absPositionError < excludeHigh & PerSubjectAlpha$absPositionError > excludeLow,],  aes(x = absPositionError, y = log1p_Alpha_Trial_Power_SD )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Alpha Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("SD(Power)") -->
<!-- lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$absPositionError < excludeHigh & PerSubjectAlpha$absPositionError > excludeLow,], log1p_Alpha_Trial_Power_SD ~ absPositionError) -->
<!-- anova(lm.model) -->
...
<!-- ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$absPositionError < excludeHigh & PerSubjectAlpha$absPositionError > excludeLow & PerSubjectAlpha$Group == 4,],  aes(x = absPositionError, y = log1p_Alpha_Trial_Power_mean )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Alpha Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("Power") -->
<!-- lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$absPositionError < excludeHigh & PerSubjectAlpha$absPositionError > excludeLow & PerSubjectAlpha$Group == 4,], log1p_Alpha_Trial_Power_mean ~ absPositionError) -->
<!-- anova(lm.model) -->

<!-- ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$absPositionError < excludeHigh & PerSubjectAlpha$absPositionError > excludeLow & PerSubjectAlpha$Group == 4,],  aes(x = absPositionError, y = log1p_Alpha_Trial_Power_SD )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Alpha Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("SD(Power)") -->
<!-- lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$absPositionError < excludeHigh & PerSubjectAlpha$absPositionError > excludeLow & PerSubjectAlpha$Group == 4,], log1p_Alpha_Trial_Power_SD ~ absPositionError) -->
<!-- anova(lm.model) -->
...
<!-- ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$mgsLatency < excludeHigh & PerSubjectAlpha$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = log1p_Alpha_Trial_Power_mean )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Alpha Power vs Latency") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Latency") + ylab("Power") -->
<!-- lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$mgsLatency < excludeHigh & PerSubjectAlpha$mgsLatency > excludeLow,], log1p_Alpha_Trial_Power_mean ~ mgsLatency) -->
<!-- anova(lm.model) -->

<!-- ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$mgsLatency < excludeHigh & PerSubjectAlpha$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = log1p_Alpha_Trial_Power_SD )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Alpha Power vs Latency") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Latency") + ylab("SD(Power)") -->
<!-- lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$mgsLatency < excludeHigh & PerSubjectAlpha$mgsLatency > excludeLow,], log1p_Alpha_Trial_Power_SD ~ mgsLatency) -->
<!-- anova(lm.model) -->
...
<!-- ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$mgsLatency < excludeHigh & PerSubjectAlpha$mgsLatency > excludeLow & PerSubjectAlpha$Group == 4,],  aes(x = mgsLatency, y = log1p_Alpha_Trial_Power_mean )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Alpha Power vs Latency") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Latency") + ylab("Power") -->
<!-- lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$mgsLatency < excludeHigh & PerSubjectAlpha$mgsLatency > excludeLow & PerSubjectAlpha$Group == 4,], log1p_Alpha_Trial_Power_mean ~ mgsLatency) -->
<!-- anova(lm.model) -->

<!-- ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$mgsLatency < excludeHigh & PerSubjectAlpha$mgsLatency > excludeLow & PerSubjectAlpha$Group == 4,],  aes(x = mgsLatency, y = log1p_Alpha_Trial_Power_SD )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Alpha Power vs Latency") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Latency") + ylab("SD(Power)") -->
<!-- lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$mgsLatency < excludeHigh & PerSubjectAlpha$mgsLatency > excludeLow & PerSubjectAlpha$Group == 4,], log1p_Alpha_Trial_Power_SD ~ mgsLatency) -->
<!-- anova(lm.model) -->
...
<!-- ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2  & PerSubjectTheta$absPositionError < excludeHigh & PerSubjectTheta$absPositionError > excludeLow,],  aes(x = absPositionError, y = log1p_Theta_Trial_Power_mean )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Theta Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("Power") -->
<!-- lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2  & PerSubjectTheta$absPositionError < excludeHigh & PerSubjectTheta$absPositionError > excludeLow,], log1p_Theta_Trial_Power_mean ~ absPositionError) -->
<!-- anova(lm.model) -->

<!-- ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2  & PerSubjectTheta$absPositionError < excludeHigh & PerSubjectTheta$absPositionError > excludeLow,],  aes(x = absPositionError, y = log1p_Theta_Trial_Power_SD )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Theta Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("SD(Power)") -->
<!-- lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$absPositionError < excludeHigh & PerSubjectTheta$absPositionError > excludeLow,], log1p_Theta_Trial_Power_SD ~ absPositionError) -->
<!-- anova(lm.model) -->
...
<!-- ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$absPositionError < excludeHigh & PerSubjectTheta$absPositionError > excludeLow & PerSubjectTheta$Group == 4,],  aes(x = absPositionError, y = log1p_Theta_Trial_Power_mean )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Theta Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("Power") -->
<!-- lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$absPositionError < excludeHigh & PerSubjectTheta$absPositionError > excludeLow & PerSubjectTheta$Group == 4,], log1p_Theta_Trial_Power_mean ~ absPositionError) -->
<!-- anova(lm.model) -->

<!-- ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$absPositionError < excludeHigh & PerSubjectTheta$absPositionError > excludeLow & PerSubjectTheta$Group == 4,],  aes(x = absPositionError, y = log1p_Theta_Trial_Power_SD )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Theta Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("SD(Power)") -->
<!-- lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$absPositionError < excludeHigh & PerSubjectTheta$absPositionError > excludeLow & PerSubjectTheta$Group == 4,], log1p_Theta_Trial_Power_SD ~ absPositionError) -->
<!-- anova(lm.model) -->
...
<!-- ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$mgsLatency < excludeHigh & PerSubjectTheta$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = log1p_Theta_Trial_Power_mean )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Theta Power vs Latency") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Latency") + ylab("Power") -->
<!-- lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$mgsLatency < excludeHigh & PerSubjectTheta$mgsLatency > excludeLow,], log1p_Theta_Trial_Power_mean ~ mgsLatency) -->
<!-- anova(lm.model) -->

<!-- ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$mgsLatency < excludeHigh & PerSubjectTheta$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = log1p_Theta_Trial_Power_SD )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Theta Power vs Latency") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Latency") + ylab("SD(Power)") -->
<!-- lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$mgsLatency < excludeHigh & PerSubjectTheta$mgsLatency > excludeLow,], log1p_Theta_Trial_Power_SD ~ mgsLatency) -->
<!-- anova(lm.model) -->
...
<!-- ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$mgsLatency < excludeHigh & PerSubjectTheta$mgsLatency > excludeLow & PerSubjectTheta$Group == 4,],  aes(x = mgsLatency, y = log1p_Theta_Trial_Power_mean )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Theta Power vs Latency") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Latency") + ylab("Power") -->
<!-- lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$mgsLatency < excludeHigh & PerSubjectTheta$mgsLatency > excludeLow & PerSubjectTheta$Group == 4,], log1p_Theta_Trial_Power_mean ~ mgsLatency) -->
<!-- anova(lm.model) -->

<!-- ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$mgsLatency < excludeHigh & PerSubjectTheta$mgsLatency > excludeLow & PerSubjectTheta$Group == 4,],  aes(x = mgsLatency, y = log1p_Theta_Trial_Power_SD )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Theta Power vs Latency") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Latency") + ylab("SD(Power)") -->
<!-- lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$mgsLatency < excludeHigh & PerSubjectTheta$mgsLatency > excludeLow & PerSubjectTheta$Group == 4,], log1p_Theta_Trial_Power_SD ~ mgsLatency) -->
<!-- anova(lm.model) -->
...
<!-- ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$absPositionError < excludeHigh & PerSubjectBeta$absPositionError > excludeLow,],  aes(x = absPositionError, y = log1p_Beta_Trial_Power_mean )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Beta Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("Power") -->
<!-- lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$absPositionError < excludeHigh & PerSubjectBeta$absPositionError > excludeLow,], log1p_Beta_Trial_Power_mean ~ absPositionError) -->
<!-- anova(lm.model) -->

<!-- ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$absPositionError < excludeHigh & PerSubjectBeta$absPositionError > excludeLow,],  aes(x = absPositionError, y = log1p_Beta_Trial_Power_SD )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Beta Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("SD(Power)") -->
<!-- lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$absPositionError < excludeHigh & PerSubjectBeta$absPositionError > excludeLow,], log1p_Beta_Trial_Power_SD ~ absPositionError) -->
<!-- anova(lm.model) -->
...
<!-- ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$absPositionError < excludeHigh & PerSubjectBeta$absPositionError > excludeLow & PerSubjectBeta$Group == 4,],  aes(x = absPositionError, y = log1p_Beta_Trial_Power_mean )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Beta Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("Power") -->
<!-- lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$absPositionError < excludeHigh & PerSubjectBeta$absPositionError > excludeLow & PerSubjectBeta$Group == 4,], log1p_Beta_Trial_Power_mean ~ absPositionError) -->
<!-- anova(lm.model) -->

<!-- ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$absPositionError < excludeHigh & PerSubjectBeta$absPositionError > excludeLow & PerSubjectBeta$Group == 4,],  aes(x = absPositionError, y = log1p_Beta_Trial_Power_SD )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Beta Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("SD(Power)") -->
<!-- lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$absPositionError < excludeHigh & PerSubjectBeta$absPositionError > excludeLow & PerSubjectBeta$Group == 4,], log1p_Beta_Trial_Power_SD ~ absPositionError) -->
<!-- anova(lm.model) -->
...
<!-- ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno <2 & PerSubjectBeta$mgsLatency < excludeHigh & PerSubjectBeta$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = log1p_Beta_Trial_Power_mean )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Beta Power vs Latency") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Latency") + ylab("Power") -->
<!-- lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno <2 & PerSubjectBeta$mgsLatency < excludeHigh & PerSubjectBeta$mgsLatency > excludeLow,], log1p_Beta_Trial_Power_mean ~ mgsLatency) -->
<!-- anova(lm.model) -->

<!-- ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno <2 & PerSubjectBeta$mgsLatency < excludeHigh & PerSubjectBeta$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = log1p_Beta_Trial_Power_SD )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Beta Power vs Latency") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Latency") + ylab("SD(Power)") -->
<!-- lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno <2 & PerSubjectBeta$mgsLatency < excludeHigh & PerSubjectBeta$mgsLatency > excludeLow,], log1p_Beta_Trial_Power_SD ~ mgsLatency) -->
<!-- anova(lm.model) -->
...
<!-- ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno <2 & PerSubjectBeta$mgsLatency < excludeHigh & PerSubjectBeta$mgsLatency > excludeLow & PerSubjectBeta$Group == 4,],  aes(x = mgsLatency, y = log1p_Beta_Trial_Power_mean )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Beta Power vs Latency") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Latency") + ylab("Power") -->
<!-- lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno <2 & PerSubjectBeta$mgsLatency < excludeHigh & PerSubjectBeta$mgsLatency > excludeLow & PerSubjectBeta$Group == 4,], log1p_Beta_Trial_Power_mean ~ mgsLatency) -->
<!-- anova(lm.model) -->

<!-- ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno <2 & PerSubjectBeta$mgsLatency < excludeHigh & PerSubjectBeta$mgsLatency > excludeLow & PerSubjectBeta$Group == 4,],  aes(x = mgsLatency, y = log1p_Beta_Trial_Power_SD )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Beta Power vs Latency") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Latency") + ylab("SD(Power)") -->
<!-- lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno <2 & PerSubjectBeta$mgsLatency < excludeHigh & PerSubjectBeta$mgsLatency > excludeLow & PerSubjectBeta$Group == 4,], log1p_Beta_Trial_Power_SD ~ mgsLatency) -->
<!-- anova(lm.model) -->
...
<!-- ```{r echo=FALSE, message=FALSE, warning=FALSE} -->
<!-- Everything$Subject <- as.factor(Everything$Subject) -->
<!-- modelFit <- lmer(absPositionError ~ age.x + log1p_Gamma_Trial_Power + (1|Subject), data = Everything[Everything$visitno.x < 2 & Everything$log1p_Gamma_Trial_Power != '-Inf',]) -->
<!-- car::Anova(modelFit) -->
<!-- ``` -->
...
<!-- ```{r echo=FALSE, message=FALSE, warning=FALSE} -->
<!-- Everything$Subject <- as.factor(Everything$Subject) -->
<!-- modelFit <- lmer(mgsLatency ~ age.x + log1p_Gamma_Trial_Power + (1|Subject), data = Everything[Everything$visitno.x < 2 & Everything$log1p_Gamma_Trial_Power != '-Inf',]) -->
<!-- car::Anova(modelFit) -->
<!-- ``` -->
...
<!-- ```{r echo=FALSE, message=FALSE, warning=FALSE} -->
<!-- Everything$Subject <- as.factor(Everything$Subject) -->
<!-- modelFit <- lmer(absPositionError ~ age.x + log1p_Alpha_Trial_Power + (1|Subject), data = Everything[Everything$visitno.x < 2 & Everything$log1p_Alpha_Trial_Power != '-Inf',]) -->
<!-- car::Anova(modelFit) -->
<!-- ``` -->
...
<!-- ```{r echo=FALSE, message=FALSE, warning=FALSE} -->
<!-- Everything$Subject <- as.factor(Everything$Subject) -->
<!-- modelFit <- lmer(mgsLatency ~ age.x + log1p_Alpha_Trial_Power + (1|Subject), data = Everything[Everything$visitno.x < 2 & Everything$log1p_Alpha_Trial_Power != '-Inf',]) -->
<!-- car::Anova(modelFit) -->
<!-- ``` -->
...
<!-- ```{r echo=FALSE, message=FALSE, warning=FALSE} -->
<!-- Everything$Subject <- as.factor(Everything$Subject) -->
<!-- modelFit <- lmer(absPositionError ~ age.x + log1p_Theta_Trial_Power + (1|Subject), data = Everything[Everything$visitno.x < 2 & Everything$log1p_Theta_Trial_Power != '-Inf',]) -->
<!-- car::Anova(modelFit) -->
<!-- ``` -->
...
<!-- ```{r echo=FALSE, message=FALSE, warning=FALSE} -->
<!-- Everything$Subject <- as.factor(Everything$Subject) -->
<!-- modelFit <- lmer(mgsLatency ~ age.x + log1p_Theta_Trial_Power + (1|Subject), data = Everything[Everything$visitno.x < 2 & Everything$log1p_Theta_Trial_Power != '-Inf',]) -->
<!-- car::Anova(modelFit) -->
<!-- ``` -->
...
<!-- ```{r echo=FALSE, message=FALSE, warning=FALSE} -->
<!-- Everything$Subject <- as.factor(Everything$Subject) -->
<!-- modelFit <- lmer(absPositionError ~ age.x + log1p_Beta_Trial_Power + (1|Subject), data = Everything[Everything$visitno.x < 2 & Everything$log1p_Beta_Trial_Power != '-Inf',]) -->
<!-- car::Anova(modelFit) -->
<!-- ``` -->
...
<!-- ```{r echo=FALSE, message=FALSE, warning=FALSE} -->
<!-- Everything$Subject <- as.factor(Everything$Subject) -->
<!-- modelFit <- lmer(mgsLatency ~ age.x + log1p_Beta_Trial_Power + (1|Subject), data = Everything[Everything$visitno.x < 2 & Everything$log1p_Beta_Trial_Power != '-Inf',]) -->
<!-- car::Anova(modelFit) -->
<!-- ``` -->
...
Avg_power1_2 <- aggregate(log1p_Gamma_Trial_Power~ Subject, GammaDelay1_2[GammaDelay1_2$Gamma_Trial_Power > 0,], mean)
Avg_power2_3 <- aggregate(log1p_Gamma_Trial_Power~ Subject, GammaDelay2_3[GammaDelay2_3$Gamma_Trial_Power > 0,], mean)
Avg_power3_4 <- aggregate(log1p_Gamma_Trial_Power~ Subject, GammaDelay3_4[GammaDelay3_4$Gamma_Trial_Power > 0,], mean)
Avg_power4_5 <- aggregate(log1p_Gamma_Trial_Power~ Subject, GammaDelay4_5[GammaDelay4_5$Gamma_Trial_Power > 0,], mean)
Avg_power5_6 <- aggregate(log1p_Gamma_Trial_Power~ Subject, GammaDelay5_6[GammaDelay5_6$Gamma_Trial_Power > 0,], mean)

sd_power1_2 <- aggregate(log1p_Gamma_Trial_Power ~ Subject, GammaDelay1_2[GammaDelay1_2$Gamma_Trial_Power > 0,], sd)
sd_power2_3 <- aggregate(log1p_Gamma_Trial_Power ~ Subject, GammaDelay2_3[GammaDelay2_3$Gamma_Trial_Power > 0,], sd)
sd_power3_4 <- aggregate(log1p_Gamma_Trial_Power ~ Subject, GammaDelay3_4[GammaDelay3_4$Gamma_Trial_Power > 0,], sd)
sd_power4_5 <- aggregate(log1p_Gamma_Trial_Power ~ Subject, GammaDelay4_5[GammaDelay4_5$Gamma_Trial_Power > 0,], sd)
sd_power5_6 <- aggregate(log1p_Gamma_Trial_Power ~ Subject, GammaDelay5_6[GammaDelay5_6$Gamma_Trial_Power > 0,], sd)
...
# DelayGammabyGroup <- setNames(aggregate(list(allDelayGamma$log1p_Gamma_Trial_Power, allDelayGamma$Gamma_Event_Number, allDelayGamma$Gamma_Event_Duration), by = list(allDelayGamma$Subject, allDelayGamma$epoch),mean), c("Group","Epoch", "Gamma_Trial_Power", "Gamma_Event_Number","Gamma_Event_Duration"))
...
### Across Age
```{r  echo=FALSE, message=FALSE, warning=FALSE}
ggplot(data = allDelayGamma,  aes(x = age, y = log1p_Gamma_Trial_Power,  color = epoch, group = epoch )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Average Gamma Power across Age \nfor Each Delay Epoch ") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Age") + ylab("Power")
```
...
### Across Time
```{r  echo=FALSE, message=FALSE, warning=FALSE}
AlphaDelay1_2 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Alpha/Delay1_2/Alpha_Subs_data_1_2.csv')
AlphaDelay2_3 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Alpha/Delay2_3/Alpha_Subs_data_2_3.csv')
...
AlphaDelay4_5 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Alpha/Delay4_5/Alpha_Subs_data_4_5.csv')
AlphaDelay5_6 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Alpha/Delay5_6/Alpha_Subs_data_5_6.csv')
...
Avg_power1_2 <- aggregate(log1p_Alpha_Trial_Power~ Subject, AlphaDelay1_2[AlphaDelay1_2$Alpha_Trial_Power > 0,], mean)
Avg_power2_3 <- aggregate(log1p_Alpha_Trial_Power~ Subject, AlphaDelay2_3[AlphaDelay2_3$Alpha_Trial_Power > 0,], mean)
Avg_power3_4 <- aggregate(log1p_Alpha_Trial_Power~ Subject, AlphaDelay3_4[AlphaDelay3_4$Alpha_Trial_Power > 0,], mean)
Avg_power4_5 <- aggregate(log1p_Alpha_Trial_Power~ Subject, AlphaDelay4_5[AlphaDelay4_5$Alpha_Trial_Power > 0,], mean)
Avg_power5_6 <- aggregate(log1p_Alpha_Trial_Power~ Subject, AlphaDelay5_6[AlphaDelay5_6$Alpha_Trial_Power > 0,], mean)

sd_power1_2 <- aggregate(log1p_Alpha_Trial_Power ~ Subject, AlphaDelay1_2[AlphaDelay1_2$Alpha_Trial_Power > 0,], sd)
sd_power2_3 <- aggregate(log1p_Alpha_Trial_Power ~ Subject, AlphaDelay2_3[AlphaDelay2_3$Alpha_Trial_Power > 0,], sd)
sd_power3_4 <- aggregate(log1p_Alpha_Trial_Power ~ Subject, AlphaDelay3_4[AlphaDelay3_4$Alpha_Trial_Power > 0,], sd)
sd_power4_5 <- aggregate(log1p_Alpha_Trial_Power ~ Subject, AlphaDelay4_5[AlphaDelay4_5$Alpha_Trial_Power > 0,], sd)
sd_power5_6 <- aggregate(log1p_Alpha_Trial_Power ~ Subject, AlphaDelay5_6[AlphaDelay5_6$Alpha_Trial_Power > 0,], sd)
...
# 
# DelayAlphabyGroup <- setNames(aggregate(list(allDelayAlpha$log1p_Alpha_Trial_Power, allDelayAlpha$Alpha_Event_Number, allDelayAlpha$Alpha_Event_Duration), by = list(allDelayAlpha$Group, allDelayAlpha$epoch),mean), c("Group","Epoch", "Alpha_Trial_Power", "Alpha_Event_Number","Alpha_Event_Duration"))
...
### Across Age
```{r  echo=FALSE, message=FALSE, warning=FALSE}
ggplot(data = allDelayAlpha,  aes(x = age, y = log1p_Alpha_Trial_Power,  color = epoch, group = epoch )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Average Alpha Power across Age \nfor Each Delay Epoch ") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Age") + ylab("Power")
```
...
```{r  echo=FALSE, message=FALSE, warning=FALSE}
ThetaDelay1_2 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Theta/Delay1_2/Theta_Subs_data1_2.csv')
ThetaDelay2_3 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Theta/Delay2_3/Theta_Subs_data2_3.csv')
...
ThetaDelay4_5 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Theta/Delay4_5/Theta_Subs_data4_5.csv')
ThetaDelay5_6 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Theta/Delay5_6/Theta_Subs_data5_6.csv')
...
Avg_power1_2 <- aggregate(log1p_Theta_Trial_Power~ Subject, ThetaDelay1_2[ThetaDelay1_2$Theta_Trial_Power > 0,], mean)
Avg_power2_3 <- aggregate(log1p_Theta_Trial_Power~ Subject, ThetaDelay2_3[ThetaDelay2_3$Theta_Trial_Power > 0,], mean)
Avg_power3_4 <- aggregate(log1p_Theta_Trial_Power~ Subject, ThetaDelay3_4[ThetaDelay3_4$Theta_Trial_Power > 0,], mean)
Avg_power4_5 <- aggregate(log1p_Theta_Trial_Power~ Subject, ThetaDelay4_5[ThetaDelay4_5$Theta_Trial_Power > 0,], mean)
Avg_power5_6 <- aggregate(log1p_Theta_Trial_Power~ Subject, ThetaDelay5_6[ThetaDelay5_6$Theta_Trial_Power > 0,], mean)


sd_power1_2 <- aggregate(log1p_Theta_Trial_Power ~ Subject, ThetaDelay1_2[ThetaDelay1_2$Theta_Trial_Power > 0,], sd)
sd_power2_3 <- aggregate(log1p_Theta_Trial_Power ~ Subject, ThetaDelay2_3[ThetaDelay2_3$Theta_Trial_Power > 0,], sd)
sd_power3_4 <- aggregate(log1p_Theta_Trial_Power ~ Subject, ThetaDelay3_4[ThetaDelay3_4$Theta_Trial_Power > 0,], sd)
sd_power4_5 <- aggregate(log1p_Theta_Trial_Power ~ Subject, ThetaDelay4_5[ThetaDelay4_5$Theta_Trial_Power > 0,], sd)
sd_power5_6 <- aggregate(log1p_Theta_Trial_Power ~ Subject, ThetaDelay5_6[ThetaDelay5_6$Theta_Trial_Power > 0,], sd)
...
# DelayThetabyGroup <- setNames(aggregate(list(allDelayTheta$log1p_Theta_Trial_Power, allDelayTheta$Theta_Event_Number, allDelayTheta$Theta_Event_Duration), by = list(allDelayTheta$Group, allDelayTheta$epoch),mean), c("Group","Epoch", "Theta_Trial_Power", "Theta_Event_Number","Theta_Event_Duration"))
...
### Across Age
```{r  echo=FALSE, message=FALSE, warning=FALSE}
ggplot(data = allDelayTheta,  aes(x = age, y = log1p_Theta_Trial_Power,  color = epoch, group = epoch )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Average Theta Power across Age \nfor Each Delay Epoch ") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Age") + ylab("Power")
```
...
```{r  echo=FALSE, message=FALSE, warning=FALSE}
BetaDelay1_2 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Beta/Delay1_2/Beta_Subs_data1_2.csv')
BetaDelay2_3 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Beta/Delay2_3/Beta_Subs_data2_3.csv')
...
BetaDelay4_5 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Beta/Delay4_5/Beta_Subs_data4_5.csv')
BetaDelay5_6 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Beta/Delay5_6/Beta_Subs_data5_6.csv')
...
Avg_power1_2 <- aggregate(log1p_Beta_Trial_Power~ Subject, BetaDelay1_2[BetaDelay1_2$Beta_Trial_Power > 0,], mean)
Avg_power2_3 <- aggregate(log1p_Beta_Trial_Power~ Subject, BetaDelay2_3[BetaDelay2_3$Beta_Trial_Power > 0,], mean)
Avg_power3_4 <- aggregate(log1p_Beta_Trial_Power~ Subject, BetaDelay3_4[BetaDelay3_4$Beta_Trial_Power > 0,], mean)
Avg_power4_5 <- aggregate(log1p_Beta_Trial_Power~ Subject, BetaDelay4_5[BetaDelay4_5$Beta_Trial_Power > 0,], mean)
Avg_power5_6 <- aggregate(log1p_Beta_Trial_Power~ Subject, BetaDelay5_6[BetaDelay5_6$Beta_Trial_Power > 0,], mean)


sd_power1_2 <- aggregate(log1p_Beta_Trial_Power ~ Subject, BetaDelay1_2[BetaDelay1_2$Beta_Trial_Power > 0,], sd)
sd_power2_3 <- aggregate(log1p_Beta_Trial_Power ~ Subject, BetaDelay2_3[BetaDelay2_3$Beta_Trial_Power > 0,], sd)
sd_power3_4 <- aggregate(log1p_Beta_Trial_Power ~ Subject, BetaDelay3_4[BetaDelay3_4$Beta_Trial_Power > 0,], sd)
sd_power4_5 <- aggregate(log1p_Beta_Trial_Power ~ Subject, BetaDelay4_5[BetaDelay4_5$Beta_Trial_Power > 0,], sd)
sd_power5_6 <- aggregate(log1p_Beta_Trial_Power ~ Subject, BetaDelay5_6[BetaDelay5_6$Beta_Trial_Power > 0,], sd)
...
# DelayBetabyGroup <- setNames(aggregate(list(allDelayBeta$log1p_Beta_Trial_Power, allDelayBeta$Beta_Event_Number, allDelayBeta$Beta_Event_Duration), by = list(allDelayBeta$Group, allDelayBeta$epoch),mean), c("Group","Epoch", "Beta_Trial_Power", "Beta_Event_Number","Beta_Event_Duration"))
...
### Across Age
```{r  echo=FALSE, message=FALSE, warning=FALSE}
ggplot(data = allDelayBeta,  aes(x = age, y = log1p_Beta_Trial_Power,  color = epoch, group = epoch )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Average Beta Power across Age \nfor Each Delay Epoch ") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Age") + ylab("Power")
```
...
write.csv(delayGamma, 'H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Gamma/delayGamma_20200821.csv')
...
write.csv(delayGamma, 'H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Alpha/delayAlpha_20200821.csv')
...
write.csv(delayGamma, 'H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Theta/delayTheta_20200821.csv')
...
write.csv(delayGamma, 'H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Beta/delayBeta_20200821.csv')
...
GammaT  <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Gamma/Fix/Gamma_Subs_Fix.csv')
AlphaT  <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Alpha/Fix/Alpha_Subs_dataFix.csv')
BetaT  <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Beta/Fix/Beta_Subs_dataFix.csv')
ThetaT  <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Theta/Fix/Theta_Subs_dataFix.csv')
agefile <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/agefile.csv')
agefile$Subject <- agefile$idvalues 
...
## NOTE: THIS MERGES WITH BEHAVIOR AND YOU ARE MISSING 12 PEOPLES. THEREFORE THE STATS ARE DIFFERENT 
# this might have been resolved - august 21 2020
...
PerSubjectGamma <- merge(PerSubjectGamma, avg_Latency, by = 'Subject',suffix = c("", "_mean"))
PerSubjectGamma <- setnames(merge(PerSubjectGamma, SD_Latency, by = 'Subject', ), c("Subject", "Trial_Power","Trial_Power_Variability", "idvalues", "age","visitno", "Event_Duration", "Event_Duration_Variability", "Event_Number","Event_Number_Variability", "ageInverse", "absPositionError", "absPositionError_SD", "mgsLatency", "mgsLatency_SD"))

write.csv(PerSubjectGamma, 'H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Gamma/Fix/fixGamma_20200821.csv')
...
PerSubjectAlpha <- merge(PerSubjectAlpha, avg_Latency, by = 'Subject',suffix = c("", "_mean"))
PerSubjectAlpha <- setnames(merge(PerSubjectAlpha, SD_Latency, by = 'Subject'), c("Subject", "Trial_Power","Trial_Power_Variability", "idvalues", "age","visitno", "Event_Duration", "Event_Duration_Variability", "Event_Number","Event_Number_Variability", "ageInverse", "absPositionError", "absPositionError_SD", "mgsLatency", "mgsLatency_SD"))

write.csv(PerSubjectAlpha, 'H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Alpha/Fix/fixAlpha_20200821.csv')
...
PerSubjectTheta <- merge(PerSubjectTheta, avg_Latency, by = 'Subject',suffix = c("", "_mean"))
PerSubjectTheta <- setnames(merge(PerSubjectTheta, SD_Latency, by = 'Subject'), c("Subject", "Trial_Power","Trial_Power_Variability", "idvalues", "age","visitno", "Event_Duration", "Event_Duration_Variability", "Event_Number","Event_Number_Variability", "ageInverse", "absPositionError", "absPositionError_SD", "mgsLatency", "mgsLatency_SD"))

write.csv(PerSubjectTheta, 'H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Theta/Fix/fixTheta_20200821.csv')
...
PerSubjectBeta <- merge(PerSubjectBeta, avg_Latency, by = 'Subject',suffix = c("", "_mean"))
PerSubjectBeta <- setnames(merge(PerSubjectBeta, SD_Latency, by = 'Subject'), c("Subject", "Trial_Power","Trial_Power_Variability", "idvalues", "age","visitno", "Event_Duration", "Event_Duration_Variability", "Event_Number","Event_Number_Variability", "ageInverse", "absPositionError", "absPositionError_SD", "mgsLatency", "mgsLatency_SD"))

write.csv(PerSubjectBeta, 'H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Beta/Fix/fixBeta_20200821.csv')
...
#average 
avgGamma <- aggregate(Trial_Power ~ visitno , PerSubjectGamma, mean)
sdGamma <- aggregate(Trial_Power ~ visitno , PerSubjectGamma, sd)
cutoff <- 3* sdGamma[1,2] + avgGamma[1,2]

ggplot(data = PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$Trial_Power < cutoff,],  aes(x = age, y = Trial_Power )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Average Trial Gamma Power vs Age") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Age") + ylab("Power")

lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$Trial_Power < cutoff,], Trial_Power ~ ageInverse)
anova(lm.model)

#trial by trial variability 
avgGamma <- aggregate(Trial_Power_Variability ~ visitno , PerSubjectGamma, mean)
sdGamma <- aggregate(Trial_Power_Variability ~ visitno , PerSubjectGamma, sd)
cutoff <- 3* sdGamma[1,2] + avgGamma[1,2]


ggplot(data = PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$Trial_Power_Variability < cutoff,],  aes(x = age, y = Trial_Power_Variability )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Between Trial Variability of Gamma Power vs Age") + theme(plot.title = element_text(hjust = 0.5))+ xlab("Age") + ylab("SD(Power)")

lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$Trial_Power_Variability < cutoff,], Trial_Power_Variability ~ ageInverse)
anova(lm.model)


# Event Duration
avgGamma <- aggregate(Event_Duration ~ visitno , PerSubjectGamma, mean)
sdGamma <- aggregate(Event_Duration ~ visitno , PerSubjectGamma, sd)
cutoff <- 3* sdGamma[1,2] + avgGamma[1,2]

ggplot(data = PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$Event_Duration < cutoff,],  aes(x = age, y = Event_Duration)) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Average Gamma Event Duration vs Age") + theme(plot.title = element_text(hjust = 0.5))+ xlab("Age") + ylab("Duration")
lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2  & PerSubjectGamma$Event_Duration < cutoff,], Event_Duration ~ ageInverse)
anova(lm.model)


# Event Duration trial by trial variability 
avgGamma <- aggregate(Event_Duration_Variability ~ visitno , PerSubjectGamma, mean)
sdGamma <- aggregate(Event_Duration_Variability ~ visitno , PerSubjectGamma, sd)
cutoff <- 3* sdGamma[1,2] + avgGamma[1,2]

ggplot(data = PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$Event_Duration_Variability < cutoff,],  aes(x = age, y = Event_Duration_Variability )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)')+ ggtitle("Between Trial Varibaility of Gamma Event Duration vs Age") + theme(plot.title = element_text(hjust = 0.5))+ xlab("Age") + ylab("SD(Duration)")
lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$Event_Duration_Variability < cutoff,], Event_Duration_Variability ~ ageInverse)
anova(lm.model)


#Event Number average
avgGamma <- aggregate(Event_Number ~ visitno , PerSubjectGamma, mean)
sdGamma <- aggregate(Event_Number ~ visitno , PerSubjectGamma, sd)
cutoff <- 3* sdGamma[1,2] + avgGamma[1,2]

ggplot(data = PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$Event_Number < cutoff,],  aes(x = age, y = Event_Number )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)')+ ggtitle("Average Gamma Event Number vs Age") + theme(plot.title = element_text(hjust = 0.5))+ xlab("Age") + ylab("Number of Events")
lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$Event_Number < cutoff,], Event_Number ~ ageInverse)
anova(lm.model)


#Event number trial variability 
avgGamma <- aggregate(Event_Number_Variability ~ visitno , PerSubjectGamma, mean)
sdGamma <- aggregate(Event_Number_Variability ~ visitno , PerSubjectGamma, sd)
cutoff <- 3* sdGamma[1,2] + avgGamma[1,2]

ggplot(data = PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$Event_Number_Variability < cutoff,],  aes(x = age, y = Event_Number_Variability )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)')+ ggtitle("Between Trial Varibaility of Gamma Event Number vs Age") + theme(plot.title = element_text(hjust = 0.5))+ xlab("Age") + ylab("SD(Number of Events)") 
lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$Event_Number_Variability < cutoff,], Event_Number_Variability ~ ageInverse)
anova(lm.model)
...
#alpha
#power
avgAlpha <- aggregate(Trial_Power ~ visitno , PerSubjectAlpha, mean)
sdAlpha <- aggregate(Trial_Power ~ visitno , PerSubjectAlpha, sd)
cutoff <- 3* sdAlpha[1,2] + avgAlpha[1,2]


ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$Trial_Power < cutoff,],  aes(x = age, y = Trial_Power )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Average Trial Alpha Power vs Age") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Age") + ylab("Power")
lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$Trial_Power < cutoff,], Trial_Power ~ ageInverse)
anova(lm.model)

#power variability 
avgAlpha <- aggregate(Trial_Power_Variability ~ visitno , PerSubjectAlpha, mean)
sdAlpha <- aggregate(Trial_Power_Variability ~ visitno , PerSubjectAlpha, sd)
cutoff <- 3* sdAlpha[1,2] + avgAlpha[1,2]

ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$Trial_Power_Variability < cutoff,],  aes(x = age, y = Trial_Power_Variability )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Between Trial Variability of Alpha Power vs Age") + theme(plot.title = element_text(hjust = 0.5))+ xlab("Age") + ylab("SD(Power)")
lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$Trial_Power_Variability < cutoff,], Trial_Power_Variability ~ ageInverse)
anova(lm.model)

#event duration 
avgAlpha <- aggregate(Event_Duration ~ visitno , PerSubjectAlpha, mean)
sdAlpha <- aggregate(Event_Duration ~ visitno , PerSubjectAlpha, sd)
cutoff <- 3* sdAlpha[1,2] + avgAlpha[1,2]


ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2  & PerSubjectAlpha$Event_Duration < cutoff,],  aes(x = age, y = Event_Duration)) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Average Trial Alpha Event Duration vs Age") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Age") + ylab("Duration")
lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2  & PerSubjectAlpha$Event_Duration < cutoff,], Event_Duration ~ ageInverse)
anova(lm.model)

#event durtion variability
avgAlpha <- aggregate(Event_Duration_Variability ~ visitno , PerSubjectAlpha, mean)
sdAlpha <- aggregate(Event_Duration_Variability ~ visitno , PerSubjectAlpha, sd)
cutoff <- 3* sdAlpha[1,2] + avgAlpha[1,2]

ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$Event_Duration_Variability < cutoff,],  aes(x = age, y = Event_Duration_Variability )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Between Trial Variability of Alpha Event Duration vs Age") + theme(plot.title = element_text(hjust = 0.5))+ xlab("Age") + ylab("SD(Duration)")
lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$Event_Duration_Variability < cutoff,], Event_Duration_Variability ~ ageInverse)
anova(lm.model)

#event number
avgAlpha <- aggregate(Event_Number ~ visitno , PerSubjectAlpha, mean)
sdAlpha <- aggregate(Event_Number ~ visitno , PerSubjectAlpha, sd)
cutoff <- 3* sdAlpha[1,2] + avgAlpha[1,2]

ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$Event_Number < cutoff,],  aes(x = age, y = Event_Number )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Average Trial Alpha Event Number vs Age") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Age") + ylab("Number of Events")
lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$Event_Number < cutoff,], Event_Number ~ ageInverse)
anova(lm.model)

#Event number variability 
avgAlpha <- aggregate(Event_Number_Variability ~ visitno , PerSubjectAlpha, mean)
sdAlpha <- aggregate(Event_Number_Variability ~ visitno , PerSubjectAlpha, sd)
cutoff <- 3* sdAlpha[1,2] + avgAlpha[1,2]

ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$Event_Number_Variability < cutoff,],  aes(x = age, y = Event_Number_Variability )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)')+ ggtitle("Between Trial Variability of Alpha Event Number vs Age") + theme(plot.title = element_text(hjust = 0.5))+ xlab("Age") + ylab("SD(Number of Events)")
lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$Event_Number_Variability < cutoff,], Event_Number_Variability ~ ageInverse)
anova(lm.model)
...
#Theta
#power
avgTheta <- aggregate(Trial_Power ~ visitno , PerSubjectTheta, mean)
sdTheta <- aggregate(Trial_Power ~ visitno , PerSubjectTheta, sd)
cutoff <- 3* sdTheta[1,2] + avgTheta[1,2]


ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$Trial_Power < cutoff,],  aes(x = age, y = Trial_Power )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Average Trial Theta Power vs Age") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Age") + ylab("Power")
lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$Trial_Power < cutoff,], Trial_Power ~ ageInverse)
anova(lm.model)

#power variability 
avgTheta <- aggregate(Trial_Power_Variability ~ visitno , PerSubjectTheta, mean)
sdTheta <- aggregate(Trial_Power_Variability ~ visitno , PerSubjectTheta, sd)
cutoff <- 3* sdTheta[1,2] + avgTheta[1,2]

ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$Trial_Power_Variability < cutoff,],  aes(x = age, y = Trial_Power_Variability )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Between Trial Variability of Theta Power vs Age") + theme(plot.title = element_text(hjust = 0.5))+ xlab("Age") + ylab("SD(Power)")
lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$Trial_Power_Variability < cutoff,], Trial_Power_Variability ~ ageInverse)
anova(lm.model)

#event duration 
avgTheta <- aggregate(Event_Duration ~ visitno , PerSubjectTheta, mean)
sdTheta <- aggregate(Event_Duration ~ visitno , PerSubjectTheta, sd)
cutoff <- 3* sdTheta[1,2] + avgTheta[1,2]


ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2  & PerSubjectTheta$Event_Duration < cutoff,],  aes(x = age, y = Event_Duration)) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Average Trial Theta Event Duration vs Age") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Age") + ylab("Duration")
lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2  & PerSubjectTheta$Event_Duration < cutoff,], Event_Duration ~ ageInverse)
anova(lm.model)

#event durtion variability
avgTheta <- aggregate(Event_Duration_Variability ~ visitno , PerSubjectTheta, mean)
sdTheta <- aggregate(Event_Duration_Variability ~ visitno , PerSubjectTheta, sd)
cutoff <- 3* sdTheta[1,2] + avgTheta[1,2]

ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$Event_Duration_Variability < cutoff,],  aes(x = age, y = Event_Duration_Variability )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Between Trial Variability of Theta Event Duration vs Age") + theme(plot.title = element_text(hjust = 0.5))+ xlab("Age") + ylab("SD(Duration)")
lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$Event_Duration_Variability < cutoff,], Event_Duration_Variability ~ ageInverse)
anova(lm.model)

#event number
avgTheta <- aggregate(Event_Number ~ visitno , PerSubjectTheta, mean)
sdTheta <- aggregate(Event_Number ~ visitno , PerSubjectTheta, sd)
cutoff <- 3* sdTheta[1,2] + avgTheta[1,2]

ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$Event_Number < cutoff,],  aes(x = age, y = Event_Number )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Average Trial Theta Event Number vs Age") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Age") + ylab("Number of Events")
lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$Event_Number < cutoff,], Event_Number ~ ageInverse)
anova(lm.model)

#Event number variability 
avgTheta <- aggregate(Event_Number_Variability ~ visitno , PerSubjectTheta, mean)
sdTheta <- aggregate(Event_Number_Variability ~ visitno , PerSubjectTheta, sd)
cutoff <- 3* sdTheta[1,2] + avgTheta[1,2]

ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$Event_Number_Variability < cutoff,],  aes(x = age, y = Event_Number_Variability )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)')+ ggtitle("Between Trial Variability of Theta Event Number vs Age") + theme(plot.title = element_text(hjust = 0.5))+ xlab("Age") + ylab("SD(Number of Events)")
lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$Event_Number_Variability < cutoff,], Event_Number_Variability ~ ageInverse)
anova(lm.model)
...
#Beta
#power
avgBeta <- aggregate(Trial_Power ~ visitno , PerSubjectBeta, mean)
sdBeta <- aggregate(Trial_Power ~ visitno , PerSubjectBeta, sd)
cutoff <- 3* sdBeta[1,2] + avgBeta[1,2]


ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$Trial_Power < cutoff,],  aes(x = age, y = Trial_Power )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Average Trial Beta Power vs Age") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Age") + ylab("Power")
lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$Trial_Power < cutoff,], Trial_Power ~ ageInverse)
anova(lm.model)

#power variability 
avgBeta <- aggregate(Trial_Power_Variability ~ visitno , PerSubjectBeta, mean)
sdBeta <- aggregate(Trial_Power_Variability ~ visitno , PerSubjectBeta, sd)
cutoff <- 3* sdBeta[1,2] + avgBeta[1,2]

ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$Trial_Power_Variability < cutoff,],  aes(x = age, y = Trial_Power_Variability )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Between Trial Variability of Beta Power vs Age") + theme(plot.title = element_text(hjust = 0.5))+ xlab("Age") + ylab("SD(Power)")
lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$Trial_Power_Variability < cutoff,], Trial_Power_Variability ~ ageInverse)
anova(lm.model)

#event duration 
avgBeta <- aggregate(Event_Duration ~ visitno , PerSubjectBeta, mean)
sdBeta <- aggregate(Event_Duration ~ visitno , PerSubjectBeta, sd)
cutoff <- 3* sdBeta[1,2] + avgBeta[1,2]


ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno < 2  & PerSubjectBeta$Event_Duration < cutoff,],  aes(x = age, y = Event_Duration)) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Average Trial Beta Event Duration vs Age") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Age") + ylab("Duration")
lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno < 2  & PerSubjectBeta$Event_Duration < cutoff,], Event_Duration ~ ageInverse)
anova(lm.model)

#event durtion variability
avgBeta <- aggregate(Event_Duration_Variability ~ visitno , PerSubjectBeta, mean)
sdBeta <- aggregate(Event_Duration_Variability ~ visitno , PerSubjectBeta, sd)
cutoff <- 3* sdBeta[1,2] + avgBeta[1,2]

ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$Event_Duration_Variability < cutoff,],  aes(x = age, y = Event_Duration_Variability )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Between Trial Variability of Beta Event Duration vs Age") + theme(plot.title = element_text(hjust = 0.5))+ xlab("Age") + ylab("SD(Duration)")
lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$Event_Duration_Variability < cutoff,], Event_Duration_Variability ~ ageInverse)
anova(lm.model)

#event number
avgBeta <- aggregate(Event_Number ~ visitno , PerSubjectBeta, mean)
sdBeta <- aggregate(Event_Number ~ visitno , PerSubjectBeta, sd)
cutoff <- 3* sdBeta[1,2] + avgBeta[1,2]

ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$Event_Number < cutoff,],  aes(x = age, y = Event_Number )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)') + ggtitle("Average Trial Beta Event Number vs Age") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Age") + ylab("Number of Events")
lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$Event_Number < cutoff,], Event_Number ~ ageInverse)
anova(lm.model)

#Event number variability 
avgBeta <- aggregate(Event_Number_Variability ~ visitno , PerSubjectBeta, mean)
sdBeta <- aggregate(Event_Number_Variability ~ visitno , PerSubjectBeta, sd)
cutoff <- 3* sdBeta[1,2] + avgBeta[1,2]

ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$Event_Number_Variability < cutoff,],  aes(x = age, y = Event_Number_Variability )) + geom_point() + stat_smooth(method='lm',  formula='y~I(1/x)')+ ggtitle("Between Trial Variability of Beta Event Number vs Age") + theme(plot.title = element_text(hjust = 0.5))+ xlab("Age") + ylab("SD(Number of Events)")
lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$Event_Number_Variability < cutoff,], Event_Number_Variability ~ ageInverse)
anova(lm.model)
```
...
ggplot(data = PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$absPositionError < excludeHigh & PerSubjectGamma$absPositionError > excludeLow ,],  aes(x = absPositionError, y = Trial_Power )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Gamma Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("Power")
lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$absPositionError < excludeHigh & PerSubjectGamma$absPositionError > excludeLow,], Trial_Power ~ absPositionError)
anova(lm.model)

ggplot(data = PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$absPositionError < excludeHigh & PerSubjectGamma$absPositionError > excludeLow,],  aes(x = absPositionError, y = Trial_Power_Variability )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Gamma Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("SD(Power)")
lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$absPositionError < excludeHigh & PerSubjectGamma$absPositionError > excludeLow,], Trial_Power_Variability ~ absPositionError)
anova(lm.model)

ggplot(data = PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$absPositionError < excludeHigh & PerSubjectGamma$absPositionError > excludeLow,],  aes(x = absPositionError, y = Event_Duration )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Gamma Event Duration vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("Duration")
lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$absPositionError < excludeHigh & PerSubjectGamma$absPositionError > excludeLow,], Event_Duration ~ absPositionError)
anova(lm.model)

ggplot(data = PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$absPositionError < excludeHigh & PerSubjectGamma$absPositionError > excludeLow,],  aes(x = absPositionError, y = Event_Duration_Variability )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Gamma Event Duration vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("SD(Duration)")
lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$absPositionError < excludeHigh & PerSubjectGamma$absPositionError > excludeLow,], Event_Duration_Variability ~ absPositionError)
anova(lm.model)

ggplot(data = PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$absPositionError < excludeHigh & PerSubjectGamma$absPositionError > excludeLow,],  aes(x = absPositionError, y = Event_Number )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Gamma Event Number vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("Number of Events")
lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$absPositionError < excludeHigh & PerSubjectGamma$absPositionError > excludeLow,], Event_Number ~ absPositionError)
anova(lm.model)

ggplot(data = PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$absPositionError < excludeHigh & PerSubjectGamma$absPositionError > excludeLow,],  aes(x = absPositionError, y = Event_Number_Variability )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Gamma Event Number vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("SD(Number of Events)")
lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$absPositionError < excludeHigh & PerSubjectGamma$absPositionError > excludeLow,], Event_Number_Variability ~ absPositionError)
anova(lm.model)
...
lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$mgsLatency < excludeHigh & PerSubjectGamma$mgsLatency > excludeLow,], Trial_Power ~ mgsLatency)
anova(lm.model)

ggplot(data = PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$mgsLatency < excludeHigh & PerSubjectGamma$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = Trial_Power_Variability )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Gamma Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("MGS Latency") + ylab("SD(Power)")
lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$mgsLatency < excludeHigh & PerSubjectGamma$mgsLatency > excludeLow,], Trial_Power_Variability ~ mgsLatency)
anova(lm.model)

ggplot(data = PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$mgsLatency < excludeHigh & PerSubjectGamma$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = Event_Duration )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Gamma Event Duration vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("MGS Latency") + ylab("Duration")
lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$mgsLatency < excludeHigh & PerSubjectGamma$mgsLatency > excludeLow,], Event_Duration ~ mgsLatency)
anova(lm.model)

ggplot(data = PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$mgsLatency < excludeHigh & PerSubjectGamma$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = Event_Duration_Variability )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Gamma Event Duration vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("MGS Latency") + ylab("SD(Duration)")
lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$mgsLatency < excludeHigh & PerSubjectGamma$mgsLatency > excludeLow,], Event_Duration_Variability ~ mgsLatency)
anova(lm.model)

ggplot(data = PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$mgsLatency < excludeHigh & PerSubjectGamma$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = Event_Number )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Gamma Event Number vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("MGS Latency") + ylab("Number of Events")
lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$mgsLatency < excludeHigh & PerSubjectGamma$mgsLatency > excludeLow,], Event_Number ~ mgsLatency)
anova(lm.model)

ggplot(data = PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$mgsLatency < excludeHigh & PerSubjectGamma$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = Event_Number_Variability )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Gamma Event Number vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("MGS Latency") + ylab("SD(Number of Events)")
lm.model <- lm(data=PerSubjectGamma[PerSubjectGamma$visitno < 2 & PerSubjectGamma$mgsLatency < excludeHigh & PerSubjectGamma$mgsLatency > excludeLow,], Event_Number_Variability ~ mgsLatency)
anova(lm.model)
...
ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$absPositionError < excludeHigh & PerSubjectAlpha$absPositionError > excludeLow ,],  aes(x = absPositionError, y = Trial_Power )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Alpha Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("Power")
lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$absPositionError < excludeHigh & PerSubjectAlpha$absPositionError > excludeLow,], Trial_Power ~ absPositionError)
anova(lm.model)

ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$absPositionError < excludeHigh & PerSubjectAlpha$absPositionError > excludeLow,],  aes(x = absPositionError, y = Trial_Power_Variability )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Alpha Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("SD(Power)")
lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$absPositionError < excludeHigh & PerSubjectAlpha$absPositionError > excludeLow,], Trial_Power_Variability ~ absPositionError)
anova(lm.model)

ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$absPositionError < excludeHigh & PerSubjectAlpha$absPositionError > excludeLow,],  aes(x = absPositionError, y = Event_Duration )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Alpha Event Duration vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("Duration")
lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$absPositionError < excludeHigh & PerSubjectAlpha$absPositionError > excludeLow,], Event_Duration ~ absPositionError)
anova(lm.model)

ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$absPositionError < excludeHigh & PerSubjectAlpha$absPositionError > excludeLow,],  aes(x = absPositionError, y = Event_Duration_Variability )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Alpha Event Duration vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("SD(Duration)")
lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$absPositionError < excludeHigh & PerSubjectAlpha$absPositionError > excludeLow,], Event_Duration_Variability ~ absPositionError)
anova(lm.model)

ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$absPositionError < excludeHigh & PerSubjectAlpha$absPositionError > excludeLow,],  aes(x = absPositionError, y = Event_Number )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Alpha Event Number vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("Number of Events")
lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$absPositionError < excludeHigh & PerSubjectAlpha$absPositionError > excludeLow,], Event_Number ~ absPositionError)
anova(lm.model)

ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$absPositionError < excludeHigh & PerSubjectAlpha$absPositionError > excludeLow,],  aes(x = absPositionError, y = Event_Number_Variability )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Alpha Event Number vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("SD(Number of Events)")
lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$absPositionError < excludeHigh & PerSubjectAlpha$absPositionError > excludeLow,], Event_Number_Variability ~ absPositionError)
anova(lm.model)
...
ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$mgsLatency < excludeHigh & PerSubjectAlpha$mgsLatency > excludeLow ,],  aes(x = mgsLatency, y = Trial_Power )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Alpha Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("MGS Latency") + ylab("Power")
lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$mgsLatency < excludeHigh & PerSubjectAlpha$mgsLatency > excludeLow,], Trial_Power ~ mgsLatency)
anova(lm.model)

ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$mgsLatency < excludeHigh & PerSubjectAlpha$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = Trial_Power_Variability )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Alpha Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("MGS Latency") + ylab("SD(Power)")
lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$mgsLatency < excludeHigh & PerSubjectAlpha$mgsLatency > excludeLow,], Trial_Power_Variability ~ mgsLatency)
anova(lm.model)

ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$mgsLatency < excludeHigh & PerSubjectAlpha$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = Event_Duration )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Alpha Event Duration vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("MGS Latency") + ylab("Duration")
lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$mgsLatency < excludeHigh & PerSubjectAlpha$mgsLatency > excludeLow,], Event_Duration ~ mgsLatency)
anova(lm.model)

ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$mgsLatency < excludeHigh & PerSubjectAlpha$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = Event_Duration_Variability )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Alpha Event Duration vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("MGS Latency") + ylab("SD(Duration)")
lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$mgsLatency < excludeHigh & PerSubjectAlpha$mgsLatency > excludeLow,], Event_Duration_Variability ~ mgsLatency)
anova(lm.model)

ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$mgsLatency < excludeHigh & PerSubjectAlpha$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = Event_Number )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Alpha Event Number vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("MGS Latency") + ylab("Number of Events")
lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$mgsLatency < excludeHigh & PerSubjectAlpha$mgsLatency > excludeLow,], Event_Number ~ mgsLatency)
anova(lm.model)

ggplot(data = PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$mgsLatency < excludeHigh & PerSubjectAlpha$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = Event_Number_Variability )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Alpha Event Number vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("MGS Latency") + ylab("SD(Number of Events)")
lm.model <- lm(data=PerSubjectAlpha[PerSubjectAlpha$visitno < 2 & PerSubjectAlpha$mgsLatency < excludeHigh & PerSubjectAlpha$mgsLatency > excludeLow,], Event_Number_Variability ~ mgsLatency)
anova(lm.model)
...
ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$absPositionError < excludeHigh & PerSubjectTheta$absPositionError > excludeLow ,],  aes(x = absPositionError, y = Trial_Power )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Theta Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("Power")
lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$absPositionError < excludeHigh & PerSubjectTheta$absPositionError > excludeLow,], Trial_Power ~ absPositionError)
anova(lm.model)

ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$absPositionError < excludeHigh & PerSubjectTheta$absPositionError > excludeLow,],  aes(x = absPositionError, y = Trial_Power_Variability )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Theta Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("SD(Power)")
lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$absPositionError < excludeHigh & PerSubjectTheta$absPositionError > excludeLow,], Trial_Power_Variability ~ absPositionError)
anova(lm.model)

ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$absPositionError < excludeHigh & PerSubjectTheta$absPositionError > excludeLow,],  aes(x = absPositionError, y = Event_Duration )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Theta Event Duration vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("Duration")
lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$absPositionError < excludeHigh & PerSubjectTheta$absPositionError > excludeLow,], Event_Duration ~ absPositionError)
anova(lm.model)

ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$absPositionError < excludeHigh & PerSubjectTheta$absPositionError > excludeLow,],  aes(x = absPositionError, y = Event_Duration_Variability )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Theta Event Duration vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("SD(Duration)")
lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$absPositionError < excludeHigh & PerSubjectTheta$absPositionError > excludeLow,], Event_Duration_Variability ~ absPositionError)
anova(lm.model)

ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$absPositionError < excludeHigh & PerSubjectTheta$absPositionError > excludeLow,],  aes(x = absPositionError, y = Event_Number )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Theta Event Number vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("Number of Events")
lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$absPositionError < excludeHigh & PerSubjectTheta$absPositionError > excludeLow,], Event_Number ~ absPositionError)
anova(lm.model)

ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$absPositionError < excludeHigh & PerSubjectTheta$absPositionError > excludeLow,],  aes(x = absPositionError, y = Event_Number_Variability )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Theta Event Number vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("SD(Number of Events)")
lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$absPositionError < excludeHigh & PerSubjectTheta$absPositionError > excludeLow,], Event_Number_Variability ~ absPositionError)
anova(lm.model)
...
ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$mgsLatency < excludeHigh & PerSubjectTheta$mgsLatency > excludeLow ,],  aes(x = mgsLatency, y = Trial_Power )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Theta Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("MGS Latency") + ylab("Power")
lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$mgsLatency < excludeHigh & PerSubjectTheta$mgsLatency > excludeLow,], Trial_Power ~ mgsLatency)
anova(lm.model)

ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$mgsLatency < excludeHigh & PerSubjectTheta$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = Trial_Power_Variability )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Theta Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("MGS Latency") + ylab("SD(Power)")
lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$mgsLatency < excludeHigh & PerSubjectTheta$mgsLatency > excludeLow,], Trial_Power_Variability ~ mgsLatency)
anova(lm.model)

ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$mgsLatency < excludeHigh & PerSubjectTheta$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = Event_Duration )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Theta Event Duration vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("MGS Latency") + ylab("Duration")
lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$mgsLatency < excludeHigh & PerSubjectTheta$mgsLatency > excludeLow,], Event_Duration ~ mgsLatency)
anova(lm.model)

ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$mgsLatency < excludeHigh & PerSubjectTheta$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = Event_Duration_Variability )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Theta Event Duration vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("MGS Latency") + ylab("SD(Duration)")
lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$mgsLatency < excludeHigh & PerSubjectTheta$mgsLatency > excludeLow,], Event_Duration_Variability ~ mgsLatency)
anova(lm.model)

ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$mgsLatency < excludeHigh & PerSubjectTheta$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = Event_Number )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Theta Event Number vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("MGS Latency") + ylab("Number of Events")
lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$mgsLatency < excludeHigh & PerSubjectTheta$mgsLatency > excludeLow,], Event_Number ~ mgsLatency)
anova(lm.model)

ggplot(data = PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$mgsLatency < excludeHigh & PerSubjectTheta$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = Event_Number_Variability )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Theta Event Number vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("MGS Latency") + ylab("SD(Number of Events)")
lm.model <- lm(data=PerSubjectTheta[PerSubjectTheta$visitno < 2 & PerSubjectTheta$mgsLatency < excludeHigh & PerSubjectTheta$mgsLatency > excludeLow,], Event_Number_Variability ~ mgsLatency)
anova(lm.model)
...
ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$absPositionError < excludeHigh & PerSubjectBeta$absPositionError > excludeLow ,],  aes(x = absPositionError, y = Trial_Power )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Beta Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("Power")
lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$absPositionError < excludeHigh & PerSubjectBeta$absPositionError > excludeLow,], Trial_Power ~ absPositionError)
anova(lm.model)

ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$absPositionError < excludeHigh & PerSubjectBeta$absPositionError > excludeLow,],  aes(x = absPositionError, y = Trial_Power_Variability )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Beta Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("SD(Power)")
lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$absPositionError < excludeHigh & PerSubjectBeta$absPositionError > excludeLow,], Trial_Power_Variability ~ absPositionError)
anova(lm.model)

ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$absPositionError < excludeHigh & PerSubjectBeta$absPositionError > excludeLow,],  aes(x = absPositionError, y = Event_Duration )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Beta Event Duration vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("Duration")
lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$absPositionError < excludeHigh & PerSubjectBeta$absPositionError > excludeLow,], Event_Duration ~ absPositionError)
anova(lm.model)

ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$absPositionError < excludeHigh & PerSubjectBeta$absPositionError > excludeLow,],  aes(x = absPositionError, y = Event_Duration_Variability )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Beta Event Duration vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("SD(Duration)")
lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$absPositionError < excludeHigh & PerSubjectBeta$absPositionError > excludeLow,], Event_Duration_Variability ~ absPositionError)
anova(lm.model)

ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$absPositionError < excludeHigh & PerSubjectBeta$absPositionError > excludeLow,],  aes(x = absPositionError, y = Event_Number )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Beta Event Number vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("Number of Events")
lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$absPositionError < excludeHigh & PerSubjectBeta$absPositionError > excludeLow,], Event_Number ~ absPositionError)
anova(lm.model)

ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$absPositionError < excludeHigh & PerSubjectBeta$absPositionError > excludeLow,],  aes(x = absPositionError, y = Event_Number_Variability )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Beta Event Number vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Abs(Position Error)") + ylab("SD(Number of Events)")
lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$absPositionError < excludeHigh & PerSubjectBeta$absPositionError > excludeLow,], Event_Number_Variability ~ absPositionError)
anova(lm.model)
...
ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$mgsLatency < excludeHigh & PerSubjectBeta$mgsLatency > excludeLow ,],  aes(x = mgsLatency, y = Trial_Power )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Beta Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("MGS Latency") + ylab("Power")
lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$mgsLatency < excludeHigh & PerSubjectBeta$mgsLatency > excludeLow,], Trial_Power ~ mgsLatency)
anova(lm.model)

ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$mgsLatency < excludeHigh & PerSubjectBeta$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = Trial_Power_Variability )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Beta Power vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("MGS Latency") + ylab("SD(Power)")
lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$mgsLatency < excludeHigh & PerSubjectBeta$mgsLatency > excludeLow,], Trial_Power_Variability ~ mgsLatency)
anova(lm.model)

ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$mgsLatency < excludeHigh & PerSubjectBeta$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = Event_Duration )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Beta Event Duration vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("MGS Latency") + ylab("Duration")
lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$mgsLatency < excludeHigh & PerSubjectBeta$mgsLatency > excludeLow,], Event_Duration ~ mgsLatency)
anova(lm.model)

ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$mgsLatency < excludeHigh & PerSubjectBeta$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = Event_Duration_Variability )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Beta Event Duration vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("MGS Latency") + ylab("SD(Duration)")
lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$mgsLatency < excludeHigh & PerSubjectBeta$mgsLatency > excludeLow,], Event_Duration_Variability ~ mgsLatency)
anova(lm.model)

ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$mgsLatency < excludeHigh & PerSubjectBeta$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = Event_Number )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Average Trial Beta Event Number vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("MGS Latency") + ylab("Number of Events")
lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$mgsLatency < excludeHigh & PerSubjectBeta$mgsLatency > excludeLow,], Event_Number ~ mgsLatency)
anova(lm.model)

ggplot(data = PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$mgsLatency < excludeHigh & PerSubjectBeta$mgsLatency > excludeLow,],  aes(x = mgsLatency, y = Event_Number_Variability )) + geom_point(aes(color = age)) + scale_color_gradient2(low = "blue", high = "red") + stat_smooth(method='lm') + ggtitle("Between Trial Variability Beta Event Number vs Position Error") + theme(plot.title = element_text(hjust = 0.5)) + xlab("MGS Latency") + ylab("SD(Number of Events)")
lm.model <- lm(data=PerSubjectBeta[PerSubjectBeta$visitno < 2 & PerSubjectBeta$mgsLatency < excludeHigh & PerSubjectBeta$mgsLatency > excludeLow,], Event_Number_Variability ~ mgsLatency)
anova(lm.model)
...
<!-- delayGamma <- setNames(aggregate(list(allDelayGamma$log1p_Gamma_Trial_Power, allDelayGamma$Gamma_Event_Number, allDelayGamma$Gamma_Event_Duration), by = list(allDelayGamma$Subject),mean), c("Subject", "Gamma_Trial_Power", "Gamma_Event_Number","Gamma_Event_Duration")) -->

<!-- delayAlpha <- setNames(aggregate(list(allDelayAlpha$log1p_Alpha_Trial_Power, allDelayAlpha$Alpha_Event_Number, allDelayAlpha$Alpha_Event_Duration), by = list(allDelayAlpha$Subject),mean), c("Subject", "Alpha_Trial_Power", "Alpha_Event_Number","Alpha_Event_Duration")) -->

<!-- delayTheta <- setNames(aggregate(list(allDelayTheta$log1p_Theta_Trial_Power, allDelayTheta$Theta_Event_Number, allDelayTheta$Theta_Event_Duration), by = list(allDelayTheta$Subject),mean), c("Subject", "Theta_Trial_Power", "Theta_Event_Number","Theta_Event_Duration")) -->

<!-- delayBeta <- setNames(aggregate(list(allDelayBeta$log1p_Beta_Trial_Power, allDelayBeta$Beta_Event_Number, allDelayBeta$Beta_Event_Duration), by = list(allDelayBeta$Subject),mean), c("Subject", "Beta_Trial_Power", "Beta_Event_Number","Beta_Event_Duration")) -->
...
<!-- ## Gamma Frequency Band -->
<!-- ```{r, echo= FALSE, message = FALSE, warning = FALSE} -->
<!-- gammaRatio$log1p_Power_Ratio <- gammaRatio$log1p_Gamma_Trial_Power_mean/gammaRatio$Gamma_Trial_Power  -->
...
<!-- ggplot(data = gammaRatio[gammaRatio$visitno < 2,],  aes(x = age, y = log1p_Power_Ratio )) + geom_point() + stat_smooth(method='loess',  formula='y~I(1/x)') + ggtitle("Average Trial Gamma Power Fixation:Delay vs Age") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Age") + ylab("Power Ratio") -->
...
<!-- ## Alpha Frequency Band -->
<!-- ```{r, echo= FALSE, message = FALSE, warning = FALSE} -->
<!-- AlphaRatio$log1p_Power_Ratio <- AlphaRatio$log1p_Alpha_Trial_Power_mean/AlphaRatio$Alpha_Trial_Power  -->
...
<!-- ggplot(data = AlphaRatio[AlphaRatio$visitno < 2,],  aes(x = age, y = log1p_Power_Ratio )) + geom_point() + stat_smooth(method='loess',  formula='y~I(1/x)') + ggtitle("Average Trial Alpha Power Fixation:Delay vs Age") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Age") + ylab("Power Ratio") -->
...
<!-- ## Theta Frequency Band -->
<!-- ```{r, echo= FALSE, message = FALSE, warning = FALSE} -->
<!-- ThetaRatio$log1p_Power_Ratio <- ThetaRatio$log1p_Theta_Trial_Power_mean/ThetaRatio$Theta_Trial_Power  -->
...
<!-- ggplot(data = ThetaRatio[ThetaRatio$visitno < 2,],  aes(x = age, y = log1p_Power_Ratio )) + geom_point() + stat_smooth(method='loess',  formula='y~I(1/x)') + ggtitle("Average Trial Theta Power Fixation:Delay vs Age") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Age") + ylab("Power Ratio") -->
...
<!-- ```{r, echo= FALSE, message = FALSE, warning = FALSE} -->
<!-- BetaRatio$log1p_Power_Ratio <- BetaRatio$log1p_Beta_Trial_Power_mean/BetaRatio$Beta_Trial_Power  -->
...
<!-- ggplot(data = BetaRatio[BetaRatio$visitno < 2,],  aes(x = age, y = log1p_Power_Ratio )) + geom_point() + stat_smooth(method='loess',  formula='y~I(1/x)') + ggtitle("Average Trial Beta Power Fixation:Delay vs Age") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Age") + ylab("Power Ratio") -->
...
GammaDelay1_2 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Gamma/Delay1_2/Gamma_Subs_PeakFreq_Power1_2.csv')
GammaDelay2_3 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Gamma/Delay2_3/Gamma_Subs_PeakFreq_Power2_3.csv')
GammaDelay3_4 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Gamma/Delay3_4/Gamma_Subs_PeakFreq_Power3_4.csv')
GammaDelay4_5 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Gamma/Delay4_5/Gamma_Subs_PeakFreq_Power4_5.csv')
GammaDelay5_6 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Gamma/Delay5_6/Gamma_Subs_PeakFreq_Power5_6.csv')
...
AlphaDelay1_2 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Alpha/Delay1_2/Alpha_Subs_PeakFreq_1_2.csv')
AlphaDelay2_3 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Alpha/Delay2_3/Alpha_Subs_PeakFreq_2_3.csv')
AlphaDelay3_4 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Alpha/Delay3_4/Alpha_Subs_PeakFreq_3_4.csv')
AlphaDelay4_5 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Alpha/Delay4_5/Alpha_Subs_PeakFreq_4_5.csv')
AlphaDelay5_6 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Alpha/Delay5_6/Alpha_Subs_PeakFreq_5_6.csv')
...
ThetaDelay1_2 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Theta/Delay1_2/Theta_Subs_PeakFreq_Power1_2.csv')
ThetaDelay2_3 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Theta/Delay2_3/Theta_Subs_PeakFreq_Power2_3.csv')
ThetaDelay3_4 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Theta/Delay3_4/Theta_Subs_PeakFreq_Power3_4.csv')
ThetaDelay4_5 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Theta/Delay4_5/Theta_Subs_PeakFreq_Power4_5.csv')
ThetaDelay5_6 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Theta/Delay5_6/Theta_Subs_PeakFreq_Power5_6.csv')
...
BetaDelay1_2 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Beta/Delay1_2/Beta_Subs_PeakFreq_Power_1_2.csv')
BetaDelay2_3 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Beta/Delay2_3/Beta_Subs_PeakFreq_Power_2_3.csv')
BetaDelay3_4 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Beta/Delay3_4/Beta_Subs_PeakFreq_Power_3_4.csv')
BetaDelay4_5 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Beta/Delay4_5/Beta_Subs_PeakFreq_Power_4_5.csv')
BetaDelay5_6 <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Beta/Delay5_6/Beta_Subs_PeakFreq_Power_5_6.csv')
...
### Gamma Frequency Band 
```{r, echo= FALSE, message = FALSE, warning = FALSE}
GammaFix <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Gamma/Fix/Gamma_Subs_PeakFreq_PowerFix.csv')

GammaFix$log_Peak_Power <- log1p(GammaFix$Gamma_Peak_Power)
...
### Alpha Frequency Band 
```{r, echo= FALSE, message = FALSE, warning = FALSE}
AlphaFix <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Alpha/Fix/Alpha_Subs_PeakFreq_Fix.csv')

AlphaFix$log_Peak_Power <- log1p(AlphaFix$Alpha_Peak_Power)
...
### Theta Frequency Band 
```{r, echo= FALSE, message = FALSE, warning = FALSE}
ThetaFix <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Theta/Fix/Theta_Subs_PeakFreq_PowerFix.csv')

ThetaFix$log_Peak_Power <- log1p(ThetaFix$Theta_Peak_Power)
...
### Beta Frequency Band 
```{r, echo= FALSE, message = FALSE, warning = FALSE}
BetaFix <- read.csv('H:/Projects/7TBrainMech/scripts/eeg/Shane/Results/Power_Analysis/Spectral_events_analysis/Beta/Fix/Beta_Subs_PeakFreq_PowerFix.csv')

BetaFix$log_Peak_Power <- log1p(BetaFix$Beta_Peak_Power)
